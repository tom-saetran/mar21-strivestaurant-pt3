...
class MyNavBar extends React.Component {
    ...
    componentDidMount = () => {
        console.log(MyNavBar.name + " initiated at " + this.state.init)
    }
        ...
        return (
            <Navbar bg="dark" variant="dark" expand="lg">
                <Navbar.Brand href="#home">
                    {this.props.title} - {this.props.title === "Strivestaurant" ? "The perfect place for pasta lovers" : "Strive For Food"}
                </Navbar.Brand>
